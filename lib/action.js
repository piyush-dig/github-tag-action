...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        core.info("This is core info.. Hello")

        const commitRef = commitSha || GITHUB_SHA;

        console.log(`commit ref is ${commitRef}`)
        if (!commitRef) {
        ...
        console.log("just before creating tag.. yay!")
        console.log(` the params are ${newTag} ${createAnnotatedTag} ${commitRef}`)
