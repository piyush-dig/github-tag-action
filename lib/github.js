...
function createTag(newTag, createAnnotatedTag, GITHUB_SHA) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        console.log('just before pushing tag')
        core.debug(`Pushing new tag to the repo.`);

        var temp = Object.assign(Object.assign({}, github_1.context.repo), { ref: `refs/tags/${newTag}`, sha: annotatedTag ? annotatedTag.data.sha : GITHUB_SHA })

        console.log(`The passed value is ${temp}`)
        ...
        console.log("last statement in createTag")
    });
}
